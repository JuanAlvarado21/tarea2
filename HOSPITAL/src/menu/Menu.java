...
public class Menu {
    ...
    private static final String USUARIO_PACIENTE = "ALVARADO";
    private final String CONTRASENIA_PACIENTE = "1234";
    private final String USUARIO_MEDICO = "JUAN";
    private final String CONTRASENIA_MEDICO = "1234";
    private final String ADMINISTRADOR = "admin1234";
    private final String CONTRASENIA_ADMINISTRADOR = "1234";
